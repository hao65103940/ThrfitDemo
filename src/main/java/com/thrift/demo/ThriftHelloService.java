...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.14.2)", date = "2022-08-01")
public class ThriftHelloService {

  /**
   * 接口: 这个是服务端提供同步调用的接口。就是说，你实现的这个接口下面的方法，都会采用同步的方式调用。
   */
